...
`AdminTable variant="integrated"` dentro de `CardContent flush`. La Card
contenedora debe usar `overflow-hidden` para respetar sus esquinas; el header
y el footer conservan las primitives normales de Card.
