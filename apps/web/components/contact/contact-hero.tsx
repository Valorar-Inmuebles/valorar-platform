...
import { CONTACT_HERO } from "@/lib/contact/contact-content";
...
export function ContactHero() {
  return (
    <section className="relative">
      ...
      <SiteContainer className="relative flex min-h-[360px] flex-col justify-end pb-12 pt-24 md:min-h-[420px] md:pb-16 md:pt-28">
