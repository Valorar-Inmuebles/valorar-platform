...
import { CONTACT_BENEFITS } from "@/lib/contact/contact-content";

export function ContactBenefitsSection() {
  return (
      ...
      <SiteContainer>
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-base leading-relaxed text-text-secondary">
            Un equipo con experiencia y trato cercano para acompañarte en cada
