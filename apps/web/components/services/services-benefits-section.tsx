...
import { SERVICES_BENEFITS } from "@/lib/services/services-content";
      ...
      <SiteContainer>
        <div className="max-w-3xl">
          <h2 className="text-2xl font-semibold tracking-tight text-text-primary md:text-3xl">
            ¿Por qué elegir Valorar Inmuebles?
          </h2>
          <p className="mt-3 text-base leading-relaxed text-text-secondary">
            Combinamos experiencia de mercado, visibilidad en los principales
            portales y un equipo multidisciplinario para acompañarte con claridad
            en cada etapa de tu operación inmobiliaria.
          </p>
        </div>

        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 md:gap-6">
          {SERVICES_BENEFITS.map((benefit) => (
            <article
              key={benefit.title}
