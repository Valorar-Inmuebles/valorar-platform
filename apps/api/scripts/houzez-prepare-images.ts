    ...
    JSON.stringify(
      {
        ...
        images: manifest.images.map((img) => ({
          ...
          trimApplied: img.trimApplied,
          trimReason: img.trimReason,
          trimPixelsRemoved: img.trimPixelsRemoved,
          trimOriginal: `${img.trimOriginalWidth}x${img.trimOriginalHeight}`,
          trimTrimmed: `${img.trimTrimmedWidth}x${img.trimTrimmedHeight}`,
        })),
      },
      null,
      2,
