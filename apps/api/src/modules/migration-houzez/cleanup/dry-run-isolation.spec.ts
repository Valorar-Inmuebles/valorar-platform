...
describe('cleanup dry-run isolation', () => {
  ...
  it('not_found rows never enter DeleteObject allowlist', () => {
    const rows: PropertyImageManifestRow[] = [
      ...
      {
        id: '3',
        propertyId: 'prop0000bbbbbbbbbbbbbbbb',
        storageKey:
          'cmqgnlvda0000ywus410xbnce/properties/prop0000bbbbbbbbbbbbbbbb/2539928a-9b7f-41aa-8f79-9bdf75c3ee00.jpg',
        url: 'https://pub.example.r2.dev/x.jpg',
        mimeType: 'image/jpeg',
        fileSize: 1,
        isCover: false,
        sortOrder: 2,
