...
export type DevelopmentGeoInput = {
...
export type ResolvedDevelopmentGeoWrite = {
  countryId: string | null;
  provinceId: string | null;
  localityId: string | null;
  neighborhoodId: string | null;
...
export class DevelopmentGeoService {
  ...
  ): Promise<ResolvedDevelopmentGeoWrite> {
