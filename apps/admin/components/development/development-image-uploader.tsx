...
import { ALLOWED_IMAGE_ACCEPT } from "@/lib/api/types/development-image";
import { validateImageFile } from "@/lib/development/image-upload";
...
type DevelopmentImageUploaderProps = {
  disabled?: boolean;
...
export function DevelopmentImageUploader({
  disabled = false,
  onUploadFiles,
  isUploading = false,
}: DevelopmentImageUploaderProps) {
